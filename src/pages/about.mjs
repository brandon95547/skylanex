    ...
    <div class="mx-auto max-w-5xl px-5 pb-10 pt-20 sm:px-8 sm:pt-24">
      <div class="grid items-center gap-10 lg:grid-cols-[1.3fr_1fr]">
        ...
        <div class="relative mx-auto w-full max-w-xs">
          <div class="monogram-halo relative grid aspect-square place-items-center rounded-3xl border border-surface-800 bg-gradient-to-br from-surface-900 to-surface-950">
